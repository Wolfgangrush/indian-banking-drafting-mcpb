"""Wolfgang Rush — Indian Banking Drafting MCPB.

Local-execution. Covers DRT, DRAT, SARFAESI, NI Act 138, IBC.

License: MIT
Source: https://github.com/Wolfgangrush/indian-banking-drafting-mcpb
...
mcp = FastMCP("wolfgang-indian-banking-drafting")

BUNDLE_ROOT = Path(__file__).resolve().parent.parent
SKILLS_DIR = BUNDLE_ROOT / "skills"
AGENTS_DIR = BUNDLE_ROOT / "agents"
PLEADING_BASE_DIR = SKILLS_DIR / "_banking_drafting_base"

CASE_TYPES: list[str] = [
    "drt-original-application",
    "drat-appeal",
    "sarfaesi-13-2-notice",
    "sarfaesi-14-cmm-dm-application",
    "sarfaesi-17-securitisation-application",
    "ni-act-138-complaint",
    "ni-act-138-reply-notice",
    "ibc-section-7-application",
    "ibc-section-95-application",
    "civil-recovery-suit",
]

CASE_TYPE_DESCRIPTIONS: dict[str, str] = {
    "drt-original-application": "DRT original application under Section 19 RDDB Act",
    "drat-appeal": "DRAT appeal under Section 20 RDDB Act",
    "sarfaesi-13-2-notice": "SARFAESI Section 13(2) demand notice",
    "sarfaesi-14-cmm-dm-application": "SARFAESI Section 14 CMM / DM possession application",
    "sarfaesi-17-securitisation-application": "Securitisation application under Section 17 SARFAESI",
    "ni-act-138-complaint": "Cheque-dishonour complaint under Section 138 NI Act",
    "ni-act-138-reply-notice": "Reply to statutory notice under Section 138 NI Act",
    "ibc-section-7-application": "IBC Section 7 financial-creditor application",
    "ibc-section-95-application": "IBC Section 95 personal-guarantor application",
    "civil-recovery-suit": "Civil suit for recovery under CPC + Negotiable Instruments Act",
}
...
FULL_ORCHESTRATION_SCRIPT = """# WOLFGANG RUSH — INDIAN BANKING FORUMS (DRT / DRAT / NCLT / CIVIL COURT) DRAFTING · FULL ORCHESTRATION SCRIPT
...
drt-original-application, drat-appeal, sarfaesi-13-2-notice, sarfaesi-14-cmm-dm-application, sarfaesi-17-securitisation-application, ni-act-138-complaint, ni-act-138-reply-notice, ibc-section-7-application, ibc-section-95-application, civil-recovery-suit.
...
def get_pleading_base() -> str:
    """Get the shared Banking drafting base structure."""

"""wolfgang_rush — Indian Banking Drafting MCPB.
...
FULL_ORCHESTRATION_SCRIPT = """# wolfgang_rush — INDIAN BANKING FORUMS (DRT / DRAT / NCLT / CIVIL COURT) DRAFTING · FULL ORCHESTRATION SCRIPT
